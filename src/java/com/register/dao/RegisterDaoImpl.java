...
public class RegisterDaoImpl implements RegisterDao {
  ...
  String ClientPasswordQuery = "INSERT INTO public.client\n"
  ...
  String ClientCodeQuery = "INSERT INTO public.client\n"
          + "(username, codeclient,"
          + " registrationdate,"
          + " phonenumber,"
          + " email, adresse,"
  ...
  String AddIndividualQuery = "INSERT INTO public.individual\n"
          + "(id, lastname,"
          + " firstname,"
          + " gender,"
          + " placeofbirth) "
  ...
  String AddOrganisationQuery = "INSERT INTO public.organization\n"
          + "(id, \"name\","
          + " industrie)\n"
          + "VALUES(?, ?, ?);";
  ...
  public String AddIndividual(RegisterBean client) {
    int Id;
    if (bundle.getString("Code-unique").equals("true")) {
      ClientQuery = ClientCodeQuery;
    } else if (bundle.getString("password").equals("true")) {
      ClientQuery = ClientPasswordQuery;
    }
    try {
      //insert in client table
      PreparedStatement preparedStatementClient = connexion.prepareStatement(ClientQuery);
      ...
      PreparedStatement preparedStatement = connexion.prepareStatement(AddIndividualQuery);
  ...
  public String AddOrganisation(RegisterBean client) {
    ...
    try {
      ...
      PreparedStatement preparedStatement = connexion.prepareStatement(AddOrganisationQuery);
