...
public class IndividualRegistration extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    String localcurrency = (String) session.getAttribute("localcurrency");
    ...
    if (bundle.getString("Code-unique").equals("true")) {
      //Generate Code
      String code = RIB.generateAccountNumber(20);
       
      ((IndividualRegistrationBean) user).setPassword(code);
    ...
    if (!ServletFileUpload.isMultipartContent(request)) {
      ...
      if (!result.equals("SUCCES")) {
        ...
        Currency currency = comptedao.getCurrency(localcurrency);
        ...
        rib = RIB.composeRIB(bank, branch, AccountNumber);
        current.setRIB(rib);
