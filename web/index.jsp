...
<fmt:bundle basename="configuration.application">
  ...
  <fmt:message key="Notification" var="CheckNotification" />
...
<html>
  ...
  <body>
    <fmt:bundle basename="i18n.Bundle">
      ...
      <div class="services">
        <c:if test = "${CheckNotification== 'true'}">
...
-->
      ...
      <footer>
        <div class="bank-logo">
          <div class="brand-title">
            <a href=""><label><i class="fa-solid fa-building-columns"></i>  ${BankName} </label></a>
