          ...
          <div class="delete_account_div popup" style="display: none;">
            <form action="DeleteAccount" method="post">
              ...
              <table>
                ...
                <tr>
                  <td><input type="submit" name="" value="<fmt:message key="title.h2.deleteAccount"/>">
        ...
        <div class="home_content">
            ...
            <div class="cards">
              <c:forEach  items="${client.getAccounts()}" var="account">
                ...
                <div class="account <c:if test='${account.getAccountType()=="checking"}'>checking</c:if>" id="${account.getId()}">
                  ...
                  <c:if test="${checkEditAccount == 'true' or checkDeleteAccount=='true'}">
                    <button type="button" class="account_menu_btn"><i class="fa-solid fa-ellipsis-vertical"></i>
                      <div class="account_menu" id="${account.getId()}">
                        <ul>
                          <c:if test="${client.getAccounts().size() > 1 and checkDeleteAccount=='true'}">
                            <li class=".delete_account_btn" onclick="openAccountDelete(${account.getId()})"><fmt:message key="text.delete"/></li>
                            </c:if>
                            <c:if test="${checkEditAccount == 'true'}">
                            <li 
                              ...
                              <c:if test="${account.getAccountType()=='checking'}">,
                                          '${account.getBudget()}', '${account.getPeriod()}'</c:if>)"><fmt:message key="text.edit"/>
                              </li>
                          </c:if>
                        </ul>
                      </div>
          ...
          <div class="transactions">
            ...
            <a href="Transaction"><label class="link-text"><fmt:message key="text.seeAll"/> </label>
              ...
              <c:if test="${checkTelecharger == 'true'}">
              <button type="button" class="account_menu_btn"><i class="fa-solid fa-ellipsis-vertical"></i>
                <div class="account_menu">
                  <ul>
                    <li class="statement_download_btn" style="white-space: nowrap;"><fmt:message key="text.downloadStmt"/></li>
                  </ul>
                </div></button>
              </c:if>
          </div>
          ...
          <div class="card-container">
                    ...
                    <div class="card_div ${card.getIdAccount()}">
                      <div class="front">
                        ...
                        <div class="row">
                          ...
                          <div class="logo">
                            <h2><i class="fa-solid fa-building-columns"></i> ${BankName}</h2>
                          </div>
                        </div>
            ...
            <c:if test="${checkCard != 'true'}">
              <h2><fmt:message key="title.h2.editAccount"/></h2>
              <c:forEach  items="${client.getAccounts()}" var="account">
                <div class="account_infos">

                  <table class="${account.getId()}">
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>${account.getCurrency().getSymbol()}</td>
                    </tr>
                    <tr>
                    ...
                    <c:if test="${account.getAccountType()=='saving'}">
                      <tr class="row_savings">
                        <td><fmt:message key="text.savingGoal"/></td>
                        <td>
                          ${account.getSavingGoal()} ${account.getCurrency().getSymbol()}</td>
                      </tr>
                    </c:if>
                    <c:if test="${account.getAccountType()!='saving'}">
                      <tr class="row_checking">
